...
import { processScheduledPosts } from "@/lib/delivery/scheduler";
...
async function handle(req: Request) {
  ...
  try {
    ...
    return Response.json({ error: "Falha ao processar os agendamentos. Veja os logs do servidor." }, { status: 500, headers: NO_STORE });
  }
}
